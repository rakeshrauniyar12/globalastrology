...
export default function TermsOfService() {
  return (
    <div className={styles.container}>
      ...
      <p>
        {" "}
        This website is operated by Om Shri Divine. Throughout the site, the terms “we”,
        “us” and “our” refer to Om Shri Divine. Om Shri Divine offers this website, including all
      ...
      <h3 className={styles.subheading}>SECTION 1 - ONLINE STORE TERMS</h3>
      <p>
      ...
      <h3 className={styles.subheading}>SECTION 2 - GENERAL CONDITIONS</h3>
      <p>
      ...
      <p>
        ...
        <a
          href="https://omshridivine.in/policies/refund-policy"
      ...
      <p>
        ...
        <a
          href="https://okplease.in/policies/refund-policy"
          className={styles.link}
        >
          Refund Policy
        </a>
      ...
      <h3 className={styles.subheading}>SECTION 7 - OPTIONAL TOOLS</h3>
      <p>
      ...
      <h3 className={styles.subheading}>SECTION 8 - THIRD-PARTY LINKS</h3>
      <p>
      ...
      <h3 className={styles.subheading}>SECTION 10 - PERSONAL INFORMATION</h3>
      <p>
        Your submission of personal information through the store is governed by
        our{" "}
        <a
          href="https://okplease.in/policies/privacy-policy"
          className={styles.link}
        >
          Privacy Policy
        </a>
      ...
      <h3 className={styles.subheading}>SECTION 12 - PROHIBITED USES</h3>
      <p>
      ...
      <p>
        In no case shall Om Shri Divine, our directors, officers, employees, affiliates,
      ...
      <h3 className={styles.subheading}>SECTION 14 - INDEMNIFICATION</h3>
      <p>
        You agree to indemnify, defend and hold harmless Om Shri Divine and our parent,
      ...
      <h3 className={styles.subheading}>SECTION 15 - SEVERABILITY</h3>
      <p>
      ...
      <h3 className={styles.subheading}>SECTION 16 - TERMINATION</h3>
      <p>
      ...
      <h3 className={styles.subheading}>SECTION 17 - ENTIRE AGREEMENT</h3>
      <p>
      ...
      <h3 className={styles.subheading}>SECTION 18 - GOVERNING LAW</h3>
      <p>
      ...
      <h3 className={styles.subheading}>SECTION 20 - CONTACT INFORMATION</h3>
      <p>
